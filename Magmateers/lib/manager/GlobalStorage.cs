using Magmateers.lib.manager.scripts;
...
namespace Magmateers.lib.manager
{
    class GlobalStorage
    {
        ...
        {
            Populate();
            MagmaLog.Log("[Global Storage]: Population Complete");
            ManagerLog.Log("[Global Storage]: Population Complete");
            LinkManagers();
            MagmaLog.Log("[Global Storage]: Managers Linked");
