...
namespace Magmateers.lib.data
{
    public class ImportHandler
    {
        ...
        {
            MagmaLog.Log("[Import Handler]: Import Started");
            Import();
            MagmaLog.Log("[Import Handler]: Import Complete");
        }
        public static Rootobject imports;
        private static readonly string path = System.Environment.GetEnvironmentVariable("USERPROFILE") + "/appdata/locallow/volcanoid/volcanoids/magmateers/data/data.json";
        private void Import()
        {
